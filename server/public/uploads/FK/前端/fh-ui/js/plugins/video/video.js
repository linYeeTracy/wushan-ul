...
(function () {
  ...
  var commonjsGlobal = typeof window_1 !== 'undefined' ? window_1 : typeof global !== 'undefined' ? global : typeof self !== 'undefined' ? self : {};

  var win;

  if (typeof window_1 !== "undefined") {
    win = window_1;
  } else if (typeof commonjsGlobal !== "undefined") {
    win = commonjsGlobal;
  } else if (typeof self !== "undefined") {
  ...
  var navigator = window_1$$1 && window_1$$1.navigator || {};
  ...
  var Flash = function (_Tech) {
    ...
    function Flash(options, ready) {
      classCallCheck$$1(this, Flash);

      // Set the source when ready
      var _this = possibleConstructorReturn$$1(this, _Tech.call(this, options, ready));
      ...
      window_1$$1.videojs = window_1$$1.videojs || {};
      window_1$$1.videojs.Flash = window_1$$1.videojs.Flash || {};
      window_1$$1.videojs.Flash.onReady = Flash.onReady;
      window_1$$1.videojs.Flash.onEvent = Flash.onEvent;
      window_1$$1.videojs.Flash.onError = Flash.onError;
    ...
    Flash.prototype.createEl = function createEl$$1() {
      ...
      if (!options.swf) {
        options.swf = 'https://vjs.zencdn.net/swf/' + version$$1 + '/video-js.swf';
      }
    ...
    */
    ...
    Flash.prototype.getVideoPlaybackQuality = function getVideoPlaybackQuality() {
      ...
      if (window_1$$1.performance && typeof window_1$$1.performance.now === 'function') {
        videoPlaybackQuality.creationTime = window_1$$1.performance.now();
      } else if (window_1$$1.performance && window_1$$1.performance.timing && typeof window_1$$1.performance.timing.navigationStart === 'number') {
        videoPlaybackQuality.creationTime = window_1$$1.Date.now() - window_1$$1.performance.timing.navigationStart;
      }
  ...
  Tech$$1.withSourceHandlers(Flash);
  ...
  */
  ...
  Flash.version = function () {
    ...
    // IE
    try {
      version$$1 = new window_1$$1.ActiveXObject('ShockwaveFlash.ShockwaveFlash').GetVariable('$version').replace(/\D+/g, ',').match(/^,?(.+),?$/)[1];
